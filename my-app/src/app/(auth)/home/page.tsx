...
export default function LoginPage() {
  return (
    <div className='relative p-3 max-w-screen'>
        <Navigation />
        <div className='bg-abbah-milk/50 mt-5 mb-[2vw] p-3 rounded-lg flex md:flex-row flex-col relative'>
          <div className="md:w-1/2 h-fit w-full text-left p-10">
          ...
          <div className="md:w-1/2 w-full h-70vh order-first">
            <Image
            src='/HeroImg.png'
            alt='Hero Image'
            layout='fill'
