      ...
      <div className='w-full h-fit flex flex-col bg-abbah-white mt-4 p-2 rounded-lg overflow-hidden'>
        ...
        <div className='flex flex-row overflow-x-scroll'>
          {allImage.map((imageSrc, index) => (
            <div key={index} className='bg-abbah-milk/10 rounded-md mx-2 relative my-3'>
              ...
              <div className='flex flex-col text-xs p-4'>
                  ...
                  <span className='flex flex-row'><span className='text-abbah-light-green'> ₦1,000,000</span>/yr</span>
                <hr className='my-2'/>
